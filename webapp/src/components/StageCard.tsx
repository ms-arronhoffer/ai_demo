...
import type { Stage } from "@/lib/demos";
import { stagePath } from "@/lib/demos";
...
export default function StageCard({ stage, demoSlug }: StageCardProps) {
  return (
    <Link
      href={stagePath(demoSlug, stage.slug)}
    ...
    >
      ...
      <div className="flex items-start justify-between">
        ...
        <span className="flex h-12 w-12 items-center justify-center rounded-lg bg-navy/5 text-navy/40 ring-1 ring-navy/5 transition-all duration-300 group-hover:bg-navy group-hover:text-gold-light group-hover:ring-navy/20">
          {STAGE_ICONS[stage.slug] ?? DEFAULT_ICON}
        </span>
      </div>
